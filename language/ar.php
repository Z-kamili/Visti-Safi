...
$lang = array(
    ...
    "title"=>"مرحبا بك في",
    "home"=>"SAFI",
    "desc-home"=>"متجذرة في التاريخ ، كانت مدينة آسفي مسرحًا للاضطرابات والتقلبات عبر تاريخها. ملاذ الملاحة ، مفترق طرق للحضارات المختلفة ، سوف يأتي Safi laiancés de l'Oceon اليوم يرغب في نشر عظمته ومجده. للحديث عن التاريخ ، هناك القليل من الكتب المكتوبة عن ولادة آسفي لأنه لا يُعرف سوى القليل عن أصولها Comptoir Phénicien - إذا صدقنا الجغرافي بطليموس - ربما تردد عليها الرومان لاحقًا ، فهي تظهر في النصوص العربية تحت اسم Asfi ، من القرن الحادي عشر ، أصبحت ميناء صغيرًا ذا أهمية محلية.",
    "contact"=>"اتصل",
    "desc-discover"=>"المدينة واسعة جدًا بالنسبة لسكانها ، وهي تفتقر إلى سحر كبير
    هل تريد اكتشاف آسفي؟ هناك ألف وطريقة واحدة لتجربة ذلك. آمل ألا تضيع بين الماضي والحاضر ، آسفي هي مدينة تاريخية تحتفظ بكل بنيتها التحتية التاريخية التي تعيد توجيهك إلى الماضي ، على الرغم من كل هذه الثروات التاريخية ، تقدم آسفي للزوار ميزة ثلاثية تتمثل في كونها مدينة ذات ماضٍ غارق. في التاريخ ، مدينة مفعمة بالحيوية والنشاط بفضل مينائها التجاري.",
    "title-discover"=>"يجب اكتشاف الخبرات",
