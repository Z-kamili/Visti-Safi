    ...
    <ul class="menu">
      ...
      <a> <select name="forma" onchange="location = this.options[this.selectedIndex].value;">
        <option><?php echo $lang['Langue']?></option>
          <option value="index.php?action=pottery&lang=en"><a href="index.php?action=home&lang=en"><?php echo $lang['lang_en']?></a></option>
          <option value="index.php?action=pottery&lang=fr"><a href="index.php?action=home&lang=fr"><?php echo $lang['lang_fr']?></a></option>
      </select></a>
